...
class PygameView:
    def __init__(self, evManager):
        ...
        self.window = display.set_mode((400, 420))
        self.winsize = self.window.get_size()
        display.set_caption("Blokus")
        self.background = Surface(self.window.get_size())
        self.background.fill((255, 255, 255))
        self.window.blit(self.background, (0, 0))
        sbLoc = (0, len(o.board.matrix) * 20 + 5)
        self.scorebox = {"surf": Surface((75, 100)), "loc": sbLoc}
        self.scorebox["surf"].fill((255, 255, 255))
        self.font = font.Font(None, 40) # Nehmen Sie None, um anzugeben, dass die Standardschriftart des Systems verwendet wird.
        pbLoc = (sbLoc[0] + 300, 0)
        self.piecebox = self.window.subsurface(Rect(pbLoc, (100, 420)))
